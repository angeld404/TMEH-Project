...
void ADC14_init() {
    ...
    ADC14->CTL0 = ( ADC14_CTL0_SHP        //pulse mode, use internal sample timer
                  ...
                  | ADC14_CTL0_SHT1_5     //sample for 96 clocks on memory location 17
                  | ADC14_CTL0_ON );      //turn ADC14 on (on/off option exists for power consumption purposes)

    ADC14->CLT1 = ( 17 << ADC14_CTL1_CSTARTADD_OFS)    //start conversions using memory 17
